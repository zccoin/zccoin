...
// zccoin: calculate Nfactor using timestamp
...
public:
    ...
    {
        // Protocol switch to support p2pool at zccoin block #9689
        //if (nHeight >= 9689)
        {
        ...
        /*// Before zccoin block #9689 - old protocol
